...
public class MongoDBInterface {
	...
	public StampedTransform lookupTransform(String targetFrameId, String sourceFrameId, Date date) {
		...
		query = QueryBuilder.start("transforms")
				.elemMatch(new BasicDBObject("child_frame_id", "/base_bellow_link"))
		...
		//db.tf.find({ 'transforms' : {$elemMatch: {"child_frame_id" : "/base_bellow_link"}}, __recorded : { "$gte": new ISODate("2013-07-24T09:37:01Z"),  "$lt": new ISODate("2013-07-24T09:57:01Z")}}, {id: 1, __recorded:1}).sort({"__recorded" : -1})
	...
	public static void main(String[] args) {
		...
		StampedTransform trans = m.lookupTransform("/sensor_mount_link", "/head_mount_kinect_ir_link", t);
